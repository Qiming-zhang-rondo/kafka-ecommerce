...
public enum OrderStatus {
    ...
    // which can be considered an anomaly (should have been at least shipped?)
     ...
     * is ought to be emitted from the seller.
    ...
    // in our case we are handling the stock directly, so
